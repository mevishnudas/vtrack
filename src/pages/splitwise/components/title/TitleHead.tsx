...
type TitleHeadProps = {
    title:string,
    addExpense:any,
    settleUpExpenseModel:any
}
const TitleHead = ({title,addExpense,settleUpExpenseModel}:TitleHeadProps) =>{
    ...
    return(<>
        <div className="grid grid-cols-3 border-b-1 border-b-gray-600 pb-2">
            ...
            <div className="col-span-2 gap-3 flex justify-end"> 
                ...
                <button className="bg-green-600 hover:bg-green-700 p-2 rounded-sm  text-sm text-shadow-sm cursor-pointer" onClick={()=>settleUpExpenseModel(true)}>Settle up</button>
            </div>
        </div>
