...
const DetailEmi = ({emi_status_list}:detailEmiProps) =>{
                ...
                <div>
                    <div className="bg-linear-to-b from-amber-200 to-amber-300 rounded-sm text-black">
                        ...
                        <div className="grid grid-cols-3 gap-1 px-3 py-2">
                            <div className="col-span-3"><label className="font-bold">Vishnu das</label></div>
                            ...
                            <div className="col-span-2 border-l-1 border-l-amber-100 pl-2">
                                <div>
                                    <label>Payment Date</label>
                                ...
                                <div>
                                    ...
                                    <p className="font-bold">26-01-2026</p>
                                </div>
                                
                                <div>
                                    <label>From</label>
                                    <p className="font-bold">KGB</p>
                                </div>
                            </div>
                        </div>
