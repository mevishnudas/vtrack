            ...
            <div className={`bg-gray-900/10 backdrop-blur-[1px] backdrop-brightness-90 fixed top-0 h-screen w-screen z-10                   
                ...
                <div className={`bg-gray-900 absolute w-55 h-screen
                    ...
                    <div>
                        ...
                        <div onClick={()=>navScreen('expenses','expenses')} className={`${activeMenu==="expenses"?"bg-gray-600":"bg-gray-800"} px-2 py-2 cursor-pointer text-amber-50 border-b-1 border-b-gray-700 flex justify-left items-center gap-2 hover:bg-gray-700 select-none`}><IoWalletOutline size={20}/> Expenses</div>
                        ...
                        <div className={`bg-slate-800 overflow-hidden transition-all duration-300 ease-in-out ${openedMenu == "repayment" ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                            <ul>
                                ...
                                <li onClick={()=>navScreen('/repayment/summary','repayment')} className="text-white px-5 hover:bg-slate-700 py-1 cursor-pointer">Summary</li>
                            </ul>
                        </div>
